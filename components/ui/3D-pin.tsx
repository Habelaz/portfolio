...
export const PinPerspective = ({
  ...
  return (
    <motion.div className="w-full h-80 flex items-center justify-center opacity-0 group-hover/pin:opacity-100 z-[60] transition duration-500 pointer-events-none group-hover/pin:pointer-events-auto">
